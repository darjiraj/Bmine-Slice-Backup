    ...
    _iap.purchaseStream.listen((List<PurchaseDetails> purchases) {
      for (PurchaseDetails purchase in purchases) {
        ...
        if (purchase.status == PurchaseStatus.purchased) {
          ...
          buySwipesApi(
            purchase.productID == "com.buy.40swipes"
                ? "40"
                : purchase.productID == "com.buy.30swipes"
                    ? "30"
                    : purchase.productID == "com.buy.15swipes"
                        ? "15"
                        : "",
            purchase.productID == "com.buy.40swipes"
                ? "12.99"
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                if (package.title != "Buy 15 Swipes" &&
                    package.title !=
                        "Buy 15 Swipes (com.app.bmine (unreviewed))")
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        package.title.isEmpty
                            ? Container()
                            : Text(
                                package.title == "Buy 30 Swipes" ||
                                        package.title ==
                                            "Buy 30 Swipes (com.app.bmine (unreviewed))"
                                    ? "Popular"
                                    : package.title == "Buy 40 Swipes" ||
                                            package.title ==
                                                "Buy 40 Swipes (com.app.bmine (unreviewed))"
                                        ? "Best Value"
                                        : "",
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                                '${Languages.of(context)!.savetxt} ${package.title == "Buy 30 Swipes" || package.title == "Buy 30 Swipes (com.app.bmine (unreviewed))" ? "23" : package.title == "Buy 40 Swipes" || package.title == "Buy 40 Swipes (com.app.bmine (unreviewed))" ? "39" : ""}%',
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                              '${package.title == "Buy 15 Swipes" || package.title == "Buy 15 Swipes (com.app.bmine (unreviewed))" ? "15" : package.title == "Buy 30 Swipes" || package.title == "Buy 30 Swipes (com.app.bmine (unreviewed))" ? "30" : package.title == "Buy 40 Swipes" || package.title == "Buy 40 Swipes (com.app.bmine (unreviewed))" ? "40" : ""} ${Languages.of(context)!.swipestxt}',
                              style: TextStyle(
                          ...
                          Column(
                            ...
                            children: [
                              // Text(
                              //     '\$${package.pricePerItem.toStringAsFixed(2)}/ea'),
                              Text(
    ...
    isInternetAvailable().then((isConnected) async {
      if (isConnected) {
        await Provider.of<PurchaseViewModel>(context, listen: false)
            .buySwipesApi(userid, count, total, verificationToken, payment_id);
        if (Provider.of<PurchaseViewModel>(context, listen: false).isLoading ==
          ...
          if (Provider.of<PurchaseViewModel>(context, listen: false)
            ...
            setState(() {
              isLoading = false;
              model = Provider.of<PurchaseViewModel>(context, listen: false)
                  .buyswipesresponse
                  .response as ForgotPasswordResponseModel;
              showToast(model.message!);
            });
            Navigator.pop(context, "${model.message}");
          } else {
            setState(() {
              isLoading = false;
            });
