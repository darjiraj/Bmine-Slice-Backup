...
extension ImageResource {
    ...
    /// The "IMG_4251" asset catalog image resource.
    static let IMG_4251 = ImageResource(name: "IMG_4251", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "IMG_4251" asset catalog image.
    static var IMG_4251: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .IMG_4251)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "IMG_4251" asset catalog image.
    static var IMG_4251: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .IMG_4251)
#else
        .init()
